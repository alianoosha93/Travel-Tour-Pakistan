...
//     navigate.push('/hotel'); // Change this path based on your routing setup
//   };
...
//                 <input type="text" name="destination" id="destination" placeholder="Dubai" className="w-full bg-gray-100 my-2 rounded-full p-2" />
//               </div>
//               <div>
//                 <label htmlFor="date" className="opacity-70">Date</label>
//                 <input type="date" name="date" id="date" className="w-full bg-gray-100 my-2 rounded-full p-2" />
//               </div>
//               <div>
...
const Hero = () => {
  ...
  const handleSearch = () => {
    // Redirect to the Hotel Page
    navigate('/hotel'); // Correctly navigate to the hotel page
  };
        ...
        <div className="container grid grid-cols-1 gap-4">
          ...
          <div data-aos="fade-up" data-aos-delay="600" className="space-y-4 bg-white rounded-md p-4 relative">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 py-3">
              <div>
                <label htmlFor="destination" className="opacity-70">Search your Destination</label>
                <input type="text" name="destination" id="destination" placeholder="Karachi" className="w-full bg-gray-100 my-2 rounded-full p-2" />
              </div>
              <div>
                <label htmlFor="date" className="opacity-70">Date</label>
                <input type="date" name="date" id="date" className="w-full bg-gray-100 my-2 rounded-full p-2" />
